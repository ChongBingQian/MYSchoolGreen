        ...
        <section className="relative overflow-hidden rounded-3xl border border-slate-200 bg-gradient-to-br from-white via-sky-50 to-emerald-50 p-6 md:p-10 shadow-sm rise-in">
          ...
          <div className="relative z-10 grid grid-cols-1 lg:grid-cols-3 gap-6 items-end">
            <div className="lg:col-span-2">
              <p className="inline-flex items-center gap-2 rounded-full border border-slate-200 bg-white/80 px-3 py-1 text-xs font-semibold text-slate-700 mb-4">
              ...
              <div className="mt-6 flex flex-wrap gap-3">
                ...
                <Link
                  to="/impact"
                  className="inline-flex items-center gap-2 rounded-xl bg-white text-slate-800 border border-slate-200 px-4 py-2.5 text-sm font-semibold hover:bg-slate-100 transition-colors"
                >
                  View Impact Story
            ...
            <div className="rounded-2xl border border-slate-200 bg-white/80 p-4 md:p-5 backdrop-blur">
              <p className="text-sm font-semibold text-slate-700 mb-3">Impact This Week</p>
              <div className="space-y-3 text-sm">
                <div className="flex justify-between items-center">
                  <span className="text-slate-500">Devices Activated</span>
                  <span className="font-semibold text-slate-900">{formatDelta(trend.devices)}</span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-slate-500">CO2 Offset</span>
                ...
                <div className="flex justify-between items-center">
                  ...
                  <span className="font-semibold text-slate-900">{formatDelta(trend.credits)}</span>
                </div>
